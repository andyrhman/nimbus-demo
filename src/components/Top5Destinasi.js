...
const Top5Destinasi = ({ loading, error, top5DestinasiSerupa, nama_destinasi }) => {
    return (
        <section className="py-6">
            <h1 className="mb-4 text-center font-sans text-2xl font-bold text-gray-900">Rekomendasi destinasi serupa <span className="text-blue-600">{nama_destinasi}</span> (MODEL 2)</h1>
            ...
            ) : top5DestinasiSerupa.length > 0 ? (
                <div className="mx-auto max-w-screen-xl p-6">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">

                        {top5DestinasiSerupa.map((tw, index) => (
                            <div key={index}>
