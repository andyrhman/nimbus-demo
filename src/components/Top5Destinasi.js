...
const Top5Destinasi = ({ loading, error, top5DestinasiSerupa, nama_destinasi }) => {
    return (
        <section className="py-6">
            <h1 className="mb-4 text-center font-sans text-2xl font-bold text-gray-900">Rekomendasi destinasi serupa <span className="text-blue-600">{nama_destinasi}</span></h1>
